  ...
  $(document).ready(function(){
    $("#search_btn").click(function(){
      if($("#q").val() == ''){
        ...
        var act = '/CodeIgniter-bbs/board/lists/ci_board/q/'+$("#q").val()+'/page/1';
...
?>
      <tr>
        ...
        <td><a rel="external" href="/CodeIgniter-bbs/<?php echo $this->uri->segment(1);?>/view/<?php echo $this->uri->segment(3);?>/board_id/<?php echo $lt->board_id;?>"><?php echo $lt->subject;?></a></td>
...
?>
  ...
  <div><p><a href="/CodeIgniter-bbs/board/write/<?php echo $this->uri->segment(3);?>/page/<?php echo $this->uri->segment(5);?>" class="btn btn-success">쓰기</a></p></div>
  <div>
